    ...
    fn fmt(
        ...
        match self {
            ...
            Self::BufferPoisoned => {
                write!(
                    f,
                    "audio buffer lock was poisoned"
                )
            }
...
impl CpalAudioStreamer {
    ...
    pub fn start(
        ...
        let error_callback =
            |error| {
                eprintln!(
                    "TinyVox streaming audio error: {error}"
                );
            };
